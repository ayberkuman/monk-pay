                  ...
                  {this.state.rows.map((i, index) => (
                    <tr key={index + "a"} id={"rowElement" + i.id}>
                      ...
                      <td className="react-infinite-table-col-4 text-right pt-2 pb-2">
                        {i.disabled ? (
                          <button
                            className="btn btn-link d-inline-flex align-items-center text-blue pl-3 pr-3 cursor-pointer"
                            onClick={(e) => {
                        ...
                        <button
                          className="btn btn-link d-inline-flex align-items-center text-pink pl-3 pr-3 cursor-pointer"
                          onClick={(e) => {
                            this.delete(index);
                          }}
                        >
